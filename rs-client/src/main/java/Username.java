...
public class Username implements Comparable {
   ...
   public boolean __equals_466(Object var1) {
      if(var1 instanceof Username) {
         ...
         return this.cleanName == null?var2.cleanName == null:(var2.cleanName == null?false:(this.__hashCode_467() != var2.__hashCode_467()?false:this.cleanName.equals(var2.cleanName)));
      } else {
         return false;
      }
   }
